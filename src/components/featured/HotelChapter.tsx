    ...
    <article className="py-20 border-b border-white/[0.08] relative">
      ...
      <div className="flex items-center justify-between font-mono text-xs text-[#9da0a8] mb-8 pb-4 border-b border-white/[0.06] uppercase tracking-widest">
        <span className="flex items-center gap-2">
          <span className="text-[#e65c24]">PROJECT 03</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12 items-baseline">
        <div className="lg:col-span-8">
          <h3 className="font-display text-3xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tighter text-[#f4f3ef] uppercase break-words">
            {project.title}
          </h3>
      ...
      <div className="my-12 border-y border-white/[0.08] py-8 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 font-mono text-xs">
          <span className="text-[#f4f3ef] font-semibold">// HOW IT WORKS: PREDICTIVE PIPELINE</span>
          <span className="text-[#5e6068]">RAPIDMINER &amp; POWER BI PIPELINE</span>
        </div>
        ...
        <div className="p-4 sm:p-6 bg-[#111215] border border-white/[0.06] flex flex-col md:flex-row md:items-center justify-between gap-4 sm:gap-6 font-mono text-xs">
          ...
          <div className="text-left md:text-right text-[#9da0a8] text-[11px] space-y-1">
            <div>ML Studio: <span className="text-[#f4f3ef]">RapidMiner</span></div>
            <div>Reporting: <span className="text-[#e65c24]">Power BI Dashboards</span></div>
          </div>
        </div>
      </div>
      ...
      <div className="my-12 rounded-2xl border border-white/[0.08] bg-[#0c0d0e] overflow-hidden shadow-2xl">
        ...
        <div className="p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Lead Time Slider */}
            <div className="p-5 rounded-xl bg-[#111215] border border-white/[0.06] space-y-3">
              <div className="flex justify-between font-mono text-xs">
                <span className="text-[#9da0a8]">BOOKING LEAD TIME</span>
                <span className="text-[#e65c24] font-bold">{leadTime} DAYS</span>
              </div>
              <input
                type="range"
                min="5"
                ...
                className="w-full accent-[#e65c24] cursor-pointer"
              />
            ...
            {/* Deposit Type */}
            <div className="p-5 rounded-xl bg-[#111215] border border-white/[0.06] space-y-3">
              <div className="font-mono text-xs text-[#9da0a8]">DEPOSIT TYPE</div>
                ...
                <button
                  ...
                  className={`py-2 px-2 rounded text-center transition-all ${
                    depositType === 'No Deposit'
                      ? 'bg-[#e65c24]/20 border border-[#e65c24] text-[#f4f3ef] font-semibold'
                      : 'bg-[#18191c] border border-white/10 text-[#9da0a8]'
                  }`}
                >
                  No Deposit
                </button>
            ...
            <div className="p-5 rounded-xl bg-[#111215] border border-white/[0.06] space-y-3">
              <div className="font-mono text-xs text-[#9da0a8]">SPECIAL REQUESTS ATTACHED</div>
              <div className="grid grid-cols-2 gap-2 font-mono text-[11px]">
                <button
                  type="button"
          ...
          <div className="p-4 sm:p-6 rounded-xl bg-[#141518] border border-white/[0.08] flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6">
            <div className="space-y-2 max-w-lg">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="font-mono text-xs text-[#5e6068]">RAPIDMINER MODEL</span>
              </div>
            ...
            <div className="text-left sm:text-right shrink-0">
              <span className="text-[10px] font-mono text-[#5e6068] block uppercase tracking-wider">PREDICTED RISK</span>
              <span className={`text-3xl sm:text-5xl font-display font-black tracking-tight ${
                calculatedProbability > 50 ? 'text-[#e65c24]' : calculatedProbability > 25 ? 'text-amber-400' : 'text-emerald-400'
              }`}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 pt-2">
            <div className="p-3 sm:p-4 rounded-xl bg-[#111215] border border-white/[0.06] text-center">
              <span className="text-[10px] font-mono text-[#5e6068] block mb-1">METHODOLOGY</span>
              <span className="font-display text-sm sm:text-base font-bold text-[#f4f3ef]">Classification</span>
            </div>
            <div className="p-3 sm:p-4 rounded-xl bg-[#111215] border border-white/[0.06] text-center">
              <span className="text-[10px] font-mono text-[#5e6068] block mb-1">TOOL</span>
              <span className="font-display text-sm sm:text-base font-bold text-[#f4f3ef]">RapidMiner</span>
            </div>
            <div className="p-3 sm:p-4 rounded-xl bg-[#111215] border border-white/[0.06] text-center">
              <span className="text-[10px] font-mono text-[#5e6068] block mb-1">DASHBOARDS</span>
              <span className="font-display text-sm sm:text-base font-bold text-[#f4f3ef]">Power BI</span>
            </div>
            <div className="p-3 sm:p-4 rounded-xl bg-[#111215] border border-white/[0.06] text-center">
              <span className="text-[10px] font-mono text-[#5e6068] block mb-1">TARGET</span>
              <span className="font-display text-sm sm:text-base font-bold text-[#e65c24]">Cancellations</span>
            </div>
          </div>
        </div>
      </div>
