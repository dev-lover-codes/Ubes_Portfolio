...
export const AboutStatement: React.FC = () => {
  ...
  const pillars = [
    { title: 'AI', desc: 'Machine learning, generative AI, and intelligent applications.' },
    { title: 'DATA', desc: 'Analytics, patterns, visualization, and turning raw data into useful insights.' },
    { title: 'SOFTWARE', desc: 'Full-stack development, backend systems, and practical applications.' },
    ...
    >
      ...
      <div className="w-full overflow-visible">
        <StackSpread
          ...
          subtitle="Exploring software, data, AI, and everything in between."
        />
      </div>
              ...
              <div className="relative aspect-[16/10] sm:aspect-[4/3] overflow-hidden bg-[#0d1322]">
                <picture>
                  ...
                  <img
                    ...
                    alt={`${PERSONAL_INFO.name} in foggy green landscape`}
